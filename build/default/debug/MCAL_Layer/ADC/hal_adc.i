...
# 23 "MCAL_Layer/ADC/../mcal_std_types.h"
...
# 17 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 18 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/hal_gpio.h" 2
# 33 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef struct{
    uint8 port :3;
    uint8 pin :3;
    uint8 direction :1;
...
# 85 "MCAL_Layer/ADC/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 50 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static __attribute__((inline)) void select_result_frormat(const adc_config_t *adc);
static __attribute__((inline)) void convertion_voltage_reference(const adc_config_t *adc);
...
if (adc->result_format == 0x01U)
    {
    *conversion_result = (adc_result) ((ADRESH <<8) + ADRESL);
    }else if(adc->result_format == 0x00U){
...
static __attribute__((inline)) void adc_input_channel_port_config(adc_channel_select_t channel){
    switch (channel){
        ...
        break;
        case ADC_CHANNEL_AN4 : (TRISA |= ((uint8)1<<0x4) );
        break;
        case ADC_CHANNEL_AN5 : (TRISA |= ((uint8)1<<0x5) );
        break;
        case ADC_CHANNEL_AN6 : (TRISE |= ((uint8)1<<0x0) );
        break;
        case ADC_CHANNEL_AN7 : (TRISE |= ((uint8)1<<0x1) );
        break;
        case ADC_CHANNEL_AN8 : (TRISE |= ((uint8)1<<0x2) );
        break;
...
static __attribute__((inline)) void convertion_voltage_reference(const adc_config_t *adc){
    if (adc->voltage_reference == 0x01U)
    {
       do{ADCON1bits.VCFG1=1; ADCON1bits.VCFG0=1; }while(0);
    }else if(adc->voltage_reference == 0x00U){
