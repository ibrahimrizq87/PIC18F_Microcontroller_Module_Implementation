...
# 33 "ECU_Layer/Keypad/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef struct{
    uint8 port :3;
    uint8 pin :3;
    uint8 direction :1;
...
# 85 "ECU_Layer/Keypad/../../MCAL_Layer/GPIO/hal_gpio.h"
...
static const uint8 keypad_char [4][4]={
                                   {'7','8','9','/'},
                                   {'4','5','6','*'},
                                   {'1','2','3','-'},
                                   {'#','0','=','+'},
...
if ((keypad == ((void*)0))||(value == ((void*)0))){
   ret =(Std_ReturnType)0x00;
}else{
    for (l_row_counter=0;l_row_counter<4;l_row_counter++){
