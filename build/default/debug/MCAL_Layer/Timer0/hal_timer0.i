...
# 14 "MCAL_Layer/Timer0/hal_timer0.h"
...
# 16 "MCAL_Layer/Timer0/../GPIO/hal_gpio.h"
...
# 23 "MCAL_Layer/Timer0/../GPIO/../mcal_std_types.h"
...
# 17 "MCAL_Layer/Timer0/../GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/Timer0/../GPIO/hal_gpio_cfg.h" 1
# 18 "MCAL_Layer/Timer0/../GPIO/hal_gpio.h" 2
# 33 "MCAL_Layer/Timer0/../GPIO/hal_gpio.h"
typedef struct{
    uint8 port :3;
    uint8 pin :3;
    uint8 direction :1;
...
# 85 "MCAL_Layer/Timer0/../GPIO/hal_gpio.h"
...
# 50 "MCAL_Layer/Timer0/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static __attribute__((inline)) void timer0_register_size_config(const timer0_t * timer0);
...
# 39 "MCAL_Layer/Timer0/hal_timer0.c"
  (INTCONbits.GIE = 1);
 (INTCONbits.PEIE = 1);
...
static __attribute__((inline)) void timer0_prescaler_config(const timer0_t * timer0)
{
    if (1 == timer0->prescaler_enable)
    {
        (T0CONbits.PSA = 0);
        T0CONbits.T0PS = timer0->prescaler_value;
    }else if (0== timer0->prescaler_enable)
    {
         (T0CONbits.PSA = 1);
    }else{ }
}
...
static __attribute__((inline)) void timer0_mode_select(const timer0_t * timer0){
    if (1 == timer0->timer0_mode){
        (T0CONbits.T0CS = 0);
    }else if (0== timer0->timer0_mode)
            {
           (T0CONbits.T0CS = 1);
...
static __attribute__((inline)) void timer0_register_size_config(const timer0_t * timer0){
    if (1 == timer0->timer0_register_size){
        (T0CONbits.T08BIT = 1);
    }else if (0== timer0->timer0_mode)
    {
        (T0CONbits.T08BIT = 0);
