...
# 33 "MCAL_Layer/Interrupt/../GPIO/hal_gpio.h"
typedef struct{
    uint8 port :3;
    uint8 pin :3;
    uint8 direction :1;
...
# 85 "MCAL_Layer/Interrupt/../GPIO/hal_gpio.h"
...
# 69 "MCAL_Layer/Interrupt/mcal_external_interrupt.h"
...
if (int_opj == ((void*)0)){
    ...
    switch(int_opj->source){
        case INTERRUPT_EXTERNAL_INT0:
             if (INTERRUPT_FALLING_EDGE==int_opj->edge){(INTCON2bits.INTEDG0 = 0);}
            else if (INTERRUPT_RISING_EDGE==int_opj->edge){(INTCON2bits.INTEDG0 = 1);}
            ret = (Std_ReturnType)0x01;
            break;
        case INTERRUPT_EXTERNAL_INT1:
            if (INTERRUPT_FALLING_EDGE==int_opj->edge){(INTCON2bits.INTEDG1 = 0);}
            else if (INTERRUPT_RISING_EDGE==int_opj->edge){(INTCON2bits.INTEDG1 = 1);}
            ret = (Std_ReturnType)0x01;
            break;
        case INTERRUPT_EXTERNAL_INT2:
             if (INTERRUPT_FALLING_EDGE==int_opj->edge){(INTCON2bits.INTEDG2 = 0);}
            else if (INTERRUPT_RISING_EDGE==int_opj->edge){(INTCON2bits.INTEDG2 = 1);}
            ret = (Std_ReturnType)0x01;
            break;
        default: ret = (Std_ReturnType)0x00;
    }
