...
if ((pin == ((void*)0)) || (pin->pin > 8 -1)){
ret= (Std_ReturnType)0x00;
}else{
    switch(pin->direction){
        case GPIO_DIRECTION_OUTPUT :
            (*tris_registers[pin->port] &= ~((uint8)1<<pin->pin) );
        break;
...
ret= (Std_ReturnType)0x00;
    ...
    *direction = ((*tris_registers[pin->port] >> pin->pin) & (uint8)1);
}
return ret;
}
...
ret= (Std_ReturnType)0x00;
     ...
     *logic = ((*port_registers[pin->port] >> pin->pin) & (uint8)1);
}
...
ret= (Std_ReturnType)0x00;
     ...
     switch(logic){
        case GPIO_LOW :
            (*lat_registers[pin->port] &= ~((uint8)1<<pin->pin) );
        break;
        case GPIO_HIGH :
            (*lat_registers[pin->port] |= ((uint8)1<<pin->pin) );
            break;
