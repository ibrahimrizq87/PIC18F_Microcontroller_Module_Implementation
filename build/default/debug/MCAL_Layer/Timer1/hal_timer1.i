...
# 16 "MCAL_Layer/Timer1/../GPIO/hal_gpio.h"
...
# 11 "MCAL_Layer/Timer1/../GPIO/../compiler.h"
...
# 11 "MCAL_Layer/Timer1/../GPIO/../compiler.h" 2
# 13 "MCAL_Layer/Timer1/../GPIO/../mcal_std_types.h" 2
# 23 "MCAL_Layer/Timer1/../GPIO/../mcal_std_types.h"
...
# 17 "MCAL_Layer/Timer1/../GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/Timer1/../GPIO/hal_gpio_cfg.h" 1
# 18 "MCAL_Layer/Timer1/../GPIO/hal_gpio.h" 2
# 33 "MCAL_Layer/Timer1/../GPIO/hal_gpio.h"
typedef struct{
    uint8 port :3;
    uint8 pin :3;
    uint8 direction :1;
...
# 85 "MCAL_Layer/Timer1/../GPIO/hal_gpio.h"
...
# 50 "MCAL_Layer/Timer1/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
# 59 "MCAL_Layer/Timer1/hal_timer1.h"
typedef struct{
...
# 2 "MCAL_Layer/Timer1/hal_timer1.c" 2


static void (*TMR1_InterruptHandler) (void) = ((void*)0);

static uint16 timer1_preload =0;
static __attribute__((inline)) void timer1_mode_select(const timer0_t * timer0);
...
Std_ReturnType Timer1_Init(const timer1_t * timer1){
    ...
    if (((void*)0) == timer1){
        ...
        (T1CONbits.TMR1ON = 0);
       (T1CONbits.T1CKPS = timer1->timer1_prescaler_value);
...
# 36 "MCAL_Layer/Timer1/hal_timer1.c"
  (INTCONbits.GIE = 1);
 (INTCONbits.PEIE = 1);
...
static __attribute__((inline)) void timer1_mode_select(const timer1_t * timer1){
    if (0 == timer1->timer1_mode){
        (T1CONbits.TMR1CS = 0);
    }else if (1== timer1->timer1_mode)
            {
           (T1CONbits.TMR1CS = 1);
           if (1==timer1->timer1_counter_mode)
           {
              (T1CONbits.T1SYNC = 1);
           }else if (0==timer1->timer1_counter_mode)
           {
               (T1CONbits.T1SYNC = 0);
           }else{ }
    }else{ }
