...
# 16 "MCAL_Layer/Timer3/../GPIO/hal_gpio.h"
...
# 11 "MCAL_Layer/Timer3/../GPIO/../compiler.h"
...
# 11 "MCAL_Layer/Timer3/../GPIO/../compiler.h" 2
# 13 "MCAL_Layer/Timer3/../GPIO/../mcal_std_types.h" 2
# 23 "MCAL_Layer/Timer3/../GPIO/../mcal_std_types.h"
...
# 16 "MCAL_Layer/Timer3/../GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/Timer3/../GPIO/../device_config.h" 1
# 17 "MCAL_Layer/Timer3/../GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/Timer3/../GPIO/hal_gpio_cfg.h" 1
# 18 "MCAL_Layer/Timer3/../GPIO/hal_gpio.h" 2
# 33 "MCAL_Layer/Timer3/../GPIO/hal_gpio.h"
typedef struct{
    uint8 port :3;
    uint8 pin :3;
    uint8 direction :1;
...
# 85 "MCAL_Layer/Timer3/../GPIO/hal_gpio.h"
...
static __attribute__((inline)) void timer3_mode_select(const timer3_t * timer3);
Std_ReturnType Timer3_Init(const timer3_t * timer3){
    ...
    if (((void*)0) == timer3){
        ...
        (T3CONbits.TMR3ON = 0);
       (T3CONbits.T3CKPS = timer3->timer3_prescaler_value);
...
# 38 "MCAL_Layer/Timer3/hal_timer3.c"
  (INTCONbits.GIE = 1);
 (INTCONbits.PEIE = 1);
...
static __attribute__((inline)) void timer3_mode_select(const timer3_t * timer3){
    if (0 == timer3->timer3_mode){
        (T3CONbits.TMR3CS = 0);
    }else if (1== timer3->timer3_mode)
            {
           (T3CONbits.TMR3CS = 1);
           if (1==timer3->timer3_counter_mode)
           {
              (T3CONbits.T3SYNC = 1);
           }else if (0==timer3->timer3_counter_mode)
           {
               (T3CONbits.T3SYNC = 0);
           }else{ }
    }else{ }
